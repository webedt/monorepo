...
export function createMockIssuesManager(overrides: Record<string, any> = {}) {
  return {
    ...
    getIssue: mock.fn(async (number: number) => createMockIssue({ number })),
    createIssue: mock.fn(async (params: any) => createMockIssue({
      title: params.title,
      body: params.body,
 ...
 */
export function createMockPullsManager(overrides: Record<string, any> = {}) {
  return {
 ...
 */
export function createMockBranchesManager(overrides: Record<string, any> = {}) {
  return {
 ...
 */
export function createMockGitHubClient(overrides: Record<string, any> = {}) {
  return {
 ...
 */
export function createMockGitHub(overrides: Record<string, any> = {}) {
  return {
 ...
 */
export function createMockClaudeResponse(tasks: any[] = []) {
  return {
    ok: true,
    json: async () => ({
      content: [{
 ...
 */
export function createMockChatSession(overrides: Record<string, any> = {}) {
  return {
    id: 'session-123',
    userId: 'user-123',
 ...
 */
export function createMockDatabase(overrides: Record<string, any> = {}) {
  return {
 ...
 */
export function createMockWorkerResult(overrides: Record<string, any> = {}) {
  return {
    success: true,
 ...
 */
export function createMockWorkerPool(overrides: Record<string, any> = {}) {
  return {
    executeTasks: mock.fn(async (tasks: any[]) =>
      tasks.map((task) => createMockWorkerResult({
        issue: task.issue,
 ...
 */
export function createMockMergeAttemptResult(overrides: Record<string, any> = {}) {
  return {
    success: true,
    pr: createMockPR(),
    merged: true,
 ...
 */
export function createMockDiscoveredTask(overrides: Record<string, any> = {}) {
  return {
 ...
 */
export function createMockCodebaseAnalysis(overrides: Record<string, any> = {}) {
  return {
    structure: [
 ...
 */
export function createMockGit(overrides: Record<string, any> = {}) {
  return {
    clone: mock.fn(async () => {}),
    init: mock.fn(async () => {}),
 ...
 * Create mock metrics
 */
export function createMockMetrics(overrides: Record<string, any> = {}) {
  return {
