...
describe('BranchManager', () => {
  ...
  describe('listBranches', () => {
    ...
    it('should throw error on API failure', async () => {
      ...
      await assert.rejects(
        async () => branchManager.listBranches(),
        /API Error/
      );
    });
  });
  ...
  describe('getBranch', () => {
    ...
    it('should throw for non-404 errors', async () => {
      ...
      await assert.rejects(
        async () => branchManager.getBranch('main'),
  ...
  describe('createBranch', () => {
    ...
    it('should return existing branch if already exists', async () => {
      mockOctokit.repos.getBranch.mock.mockImplementation(async (params: any) => {
      ...
      const alreadyExistsError: any = new Error('Reference already exists');
    ...
    it('should throw for other creation errors', async () => {
      ...
      await assert.rejects(
        async () => branchManager.createBranch('new-branch', 'main'),
        /Server error/
      );
    });
  });
  ...
  describe('deleteBranch', () => {
    ...
    it('should throw for other deletion errors', async () => {
      const forbiddenError: any = new Error('Cannot delete protected branch');
      ...
      await assert.rejects(
        async () => branchManager.deleteBranch('protected-branch'),
