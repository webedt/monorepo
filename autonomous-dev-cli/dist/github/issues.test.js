...
function createMockClient(overrides = {}) {
    ...
    return {
        ...
        executeWithFallback: mock.fn(async (operation, fallback) => {
            try {
...
function createMockApiIssue(overrides = {}) {
    return {
        number: 1,
        title: 'Test Issue',
...
describe('IssueManager', () => {
    ...
    describe('getIssue', () => {
        ...
        it('should throw for other errors', async () => {
            ...
            await assert.rejects(async () => issueManager.getIssue(1), /Server Error/);
        });
    ...
    describe('createIssue', () => {
        ...
        it('should throw on creation failure', async () => {
            ...
            await assert.rejects(async () => issueManager.createIssue({ title: 'Test', body: 'Test' }), /Rate limited/);
        });
    });
    describe('addLabels', () => {
        ...
        it('should throw on failure', async () => {
            ...
            await assert.rejects(async () => issueManager.addLabels(1, ['test']), /Not authorized/);
        });
    });
    ...
    describe('removeLabel', () => {
        ...
        it('should not throw if label does not exist (404)', async () => {
            const notFoundError = new Error('Label not found');
            notFoundError.status = 404;
            mockOctokit.issues.removeLabel.mock.mockImplementation(async () => {
                throw notFoundError;
            });
        ...
        it('should throw for other errors', async () => {
            ...
            await assert.rejects(async () => issueManager.removeLabel(1, 'test'), /Server error/);
        });
    });
    describe('closeIssue', () => {
    ...
    describe('addComment', () => {
        ...
        it('should throw on failure', async () => {
            ...
            await assert.rejects(async () => issueManager.addComment(1, 'Test'), /Comment failed/);
        });
    });
