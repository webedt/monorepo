...
function createMockApiPR(overrides = {}) {
    return {
        number: 1,
        title: 'Test PR',
        body: 'PR description',
...
describe('PRManager', () => {
    ...
    describe('listOpenPRs', () => {
        ...
        it('should throw on API failure', async () => {
            ...
            await assert.rejects(async () => prManager.listOpenPRs(), /API Error/);
        });
    });
    ...
    describe('getPR', () => {
        ...
        it('should throw for other errors', async () => {
            ...
            await assert.rejects(async () => prManager.getPR(1), /Server Error/);
        });
    ...
    describe('createPR', () => {
        ...
        it('should handle PR already exists error', async () => {
            ...
            const alreadyExistsError = new Error('A pull request already exists');
    ...
    describe('closePR', () => {
        ...
        it('should throw on failure', async () => {
            ...
            await assert.rejects(async () => prManager.closePR(1), /Not authorized/);
        });
    });
    describe('updatePRFromBase', () => {
        ...
        it('should return true if already up to date (204)', async () => {
            ...
            const noContentError = new Error('Already up to date');
    ...
    describe('getChecksStatus', () => {
        ...
        it('should throw on failure', async () => {
            ...
            await assert.rejects(async () => prManager.getChecksStatus('abc123'), /API Error/);
        });
    });
...
//# sourceMappingURL=pulls.test.js.map