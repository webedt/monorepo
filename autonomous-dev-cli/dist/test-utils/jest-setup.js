            ...
            async toCompleteWithin(received, timeoutMs) {
                ...
                try {
                    ...
                    return {
                        ...
                        message: () => `expected promise to complete within ${timeoutMs}ms, completed in ${elapsed}ms`,
                    };
                }
                catch {
                    return {
                        pass: false,
                        message: () => `expected promise to complete within ${timeoutMs}ms, but it timed out or rejected`,
                    };
                }
            },
        });
