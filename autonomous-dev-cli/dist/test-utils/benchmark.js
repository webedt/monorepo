...
function formatResult(result, threshold) {
    const status = threshold && result.avgMs > threshold
...
async function benchmarkConfigLoading() {
    ...
    try {
        return await runBenchmark('Config loading', () => {
 ...
 */
async function benchmarkMockCreation() {
    return await runBenchmark('Mock creation', () => {
 ...
 */
async function benchmarkStringManipulation() {
    const titles = [
    ...
    return await runBenchmark('String manipulation', () => {
...
async function benchmarkArrayOperations() {
    ...
    return await runBenchmark('Array operations', () => {
        items
 ...
 */
async function benchmarkFileSystemSetup() {
    return await runBenchmark('File system setup', () => {
...
async function benchmarkErrorHandling() {
    return await runBenchmark('Error handling', () => {
        try {
 ...
 */
async function benchmarkDateOperations() {
    return await runBenchmark('Date operations', () => {
        const now = new Date();
