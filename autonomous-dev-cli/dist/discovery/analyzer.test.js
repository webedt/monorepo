...
describe('CodebaseAnalyzer', () => {
    ...
    describe('analyze', () => {
      ...
      `);
        ...
        it('should throw AnalyzerError for invalid path', async () => {
            ...
            await assert.rejects(() => analyzer.analyze(), (error) => {
    ...
    describe('AnalyzerError', () => {
        it('should include path in context', () => {
            const error = new AnalyzerError(ErrorCode.ANALYZER_PATH_NOT_FOUND, 'Path not found', { path: '/test/path' });
        ...
        it('should not be retryable', () => {
            const error = new AnalyzerError(ErrorCode.ANALYZER_INVALID_GLOB_PATTERN, 'Invalid pattern');
