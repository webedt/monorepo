...
export class InteractivePreview {
    ...
    displayTask(task, index, total) {
        ...
        console.log(`  ${priorityColor(`[${task.priority}]`)} ` +
     ...
     */
    async promptAction(allowedActions) {
    ...
    async handleSort() {
        ...
        const fields = ['priority', 'category', 'complexity', 'title', 'status'];
 ...
 */
export async function runInteractivePreview(session, savePath) {
