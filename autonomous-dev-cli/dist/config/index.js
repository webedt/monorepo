 ...
 */
function buildRecoveryActionsFromValidation(errors) {
    const actions = [];
 ...
 */
function createConfigValidationError(zodError, configPath) {
    ...
    return new ConfigError(ErrorCode.CONFIG_VALIDATION_FAILED, `Configuration validation failed: ${errorMessages.join('; ')}`, {
        field,
