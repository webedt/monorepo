/**
 * Helper for making LLM requests for session title, branch name, and commit message generation
 * Uses Claude Agent SDK with Haiku for fast, cost-effective responses
 * Consolidated from github-worker/src/utils/llmHelper.ts
 */
...
export class LLMHelper {
  ...
  constructor(cwd?: string) {
    this.cwd = cwd || '/tmp';
    logger.info('LLMHelper initialized with Claude Agent SDK', {
      component: 'LLMHelper',
      cwd: this.cwd
    });
  }
