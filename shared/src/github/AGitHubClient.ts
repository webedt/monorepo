...
import type { IGitHubClientDocumentation } from './githubClient.doc.js';
...
export abstract class AGitHubClient extends AService implements IGitHubClientDocumentation {
