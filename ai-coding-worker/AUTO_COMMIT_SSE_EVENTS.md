...
All auto-commit events include a `source` field to identify the origin. Auto-commit events are generated by the `ai-coding-worker`.
...
- **source**: Always `"ai-coding-worker"` for auto-commit events
