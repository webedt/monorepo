                          ...
                          <div className="absolute top-full left-0 mt-2 w-64 max-h-80 bg-base-100 rounded-lg shadow-xl border border-base-300 overflow-hidden z-50">
                            ...
                            <div className="overflow-y-auto max-h-64">
                              ...
                              <button
                                ...
                                className={`w-full text-left px-4 py-2 text-sm hover:bg-yellow-300 ${!selectedRepo ? 'bg-primary/10 font-semibold' : ''}`}
                              >
                                No repository
                              </button>
                              ...
                              {filteredRepositories.length > 0 ? (
                                filteredRepositories.map((repo) => (
                                  <button
                                    ...
                                    className={`w-full text-left px-4 py-2 text-sm hover:bg-yellow-300 ${selectedRepo === repo.cloneUrl ? 'bg-primary/10 font-semibold' : ''}`}
                                  >
                                    {repo.fullName}
                                  </button>
                                ))
                                  ...
                                  {filteredBranches.length > 0 ? (
                                    filteredBranches.map((branchName) => (
                                      <button
                                        ...
                                        className={`w-full text-left px-4 py-2 text-sm hover:bg-yellow-300 ${baseBranch === branchName ? 'bg-primary/10 font-semibold' : ''}`}
                                      >
                                        {branchName}
                                      </button>
                                    ))
