...
// Requires editor role or higher to access AI execution features
router.post('/', requireAuth, requireEditor, aiOperationRateLimiter, executeRemoteHandler);
router.get('/', requireAuth, requireEditor, aiOperationRateLimiter, executeRemoteHandler);
