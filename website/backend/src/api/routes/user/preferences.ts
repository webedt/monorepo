...
router.post('/preferred-provider', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Update preferred provider error', error as Error, { component: 'user', operation: 'updatePreferredProvider' });
...
router.post('/image-resize-setting', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Update image resize setting error', error as Error, { component: 'user', operation: 'updateImageResizeSetting' });
...
router.post('/display-name', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Update display name error', error as Error, { component: 'user', operation: 'updateDisplayName' });
...
router.post('/voice-command-keywords', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Update voice command keywords error', error as Error, { component: 'user', operation: 'updateVoiceCommandKeywords' });
...
router.post('/stop-listening-after-submit', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Update stop listening after submit error', error as Error, { component: 'user', operation: 'updateStopListeningAfterSubmit' });
...
router.post('/default-landing-page', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Update default landing page error', error as Error, { component: 'user', operation: 'updateDefaultLandingPage' });
...
router.post('/preferred-model', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Update preferred model error', error as Error, { component: 'user', operation: 'updatePreferredModel' });
...
router.post('/chat-verbosity', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Update chat verbosity level error', error as Error, { component: 'user', operation: 'updateChatVerbosity' });
...
router.post('/openrouter-api-key', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Update OpenRouter API key error', error as Error, { component: 'user', operation: 'updateOpenRouterApiKey' });
...
router.delete('/openrouter-api-key', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Remove OpenRouter API key error', error as Error, { component: 'user', operation: 'removeOpenRouterApiKey' });
...
router.post('/autocomplete-settings', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Update autocomplete settings error', error as Error, { component: 'user', operation: 'updateAutocompleteSettings' });
...
router.post('/image-ai-keys', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Update image AI keys error', error as Error, { component: 'user', operation: 'updateImageAiKeys' });
...
router.post('/image-ai-provider', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Update image AI provider error', error as Error, { component: 'user', operation: 'updateImageAiProvider' });
...
router.post('/image-ai-model', requireAuth, async (req: Request, res: Response) => {
  try {
    ...
    logger.error('Update image AI model error', error as Error, { component: 'user', operation: 'updateImageAiModel' });
