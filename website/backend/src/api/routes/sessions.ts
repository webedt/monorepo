...
// Create a new code session - requires editor role or higher
...
// Requires editor role or higher for sending messages
router.post('/:id/send', requireAuth, requireEditor, async (req: Request, res: Response) => {
  try {
    const authReq = req as AuthRequest;
    const sessionId = req.params.id;
