...
router.post('/sync', requireAuth, async (req: Request, res: Response) => {
  ...
  try {
    ...
    // Note: Transaction handling for sync operations is managed within the shared package
    // as it involves complex multi-step operations with external API calls
