 ...
 *
 * Usage: Apply to routes that require editor access, e.g.:
 *   router.post('/create-game', requireEditor, createGameHandler);
 *   router.put('/edit-content', requireEditor, editContentHandler);
 */
 ...
 *
 * Usage: Apply to routes that require developer access, e.g.:
 *   router.get('/api-keys', requireDeveloper, apiKeysHandler);
 *   router.post('/webhooks', requireDeveloper, webhooksHandler);
 */
