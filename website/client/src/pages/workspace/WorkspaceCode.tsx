...
export default function WorkspaceCode() {
  ...
  if (!workspace) {
    return null; // WorkspaceLayout handles this case
  }
      ...
      <div className="flex flex-col items-center justify-center h-full bg-base-200 p-8">
        <div className="text-center max-w-lg">
          ...
          <p className="text-base-content/70 mb-6">
            Live workspace for <span className="font-mono text-primary">{owner}/{repo}</span>
          </p>
          ...
          <div className="alert alert-info">
            ...
            <span>GitHub API integration coming in Phase 4. File tree and editing will use the GitHub API directly.</span>
          </div>
        </div>
      </div>
    </WorkspaceLayout>
