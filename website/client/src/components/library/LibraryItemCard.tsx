...
/**
 * LibraryItemCard - Grid view card component for library items.
 * Displays thumbnail, title, description, and action buttons.
 */
  ...
  const renderFavoriteButton = () => (
    ...
    >
      <svg
        ...
        className={`h-5 w-5 ${isFavorite ? 'text-warning fill-warning' : ''}`}
        viewBox="0 0 24 24"
