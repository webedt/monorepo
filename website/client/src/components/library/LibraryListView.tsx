...
/**
 * LibraryListView - Standard list view with more details for library items.
...
export default function LibraryListView({
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="hidden md:flex items-center gap-4 px-4 py-3 bg-base-300 rounded-lg font-semibold text-sm mb-2">
        ...
        <button
          ...
          className="w-32 flex items-center gap-2 hover:text-primary transition-colors"
        >
          Date Added
          {renderSortIcon('purchasedDate')}
        </button>
        <button
          onClick={() => onSort('lastPlayedDate')}
          className="w-32 flex items-center gap-2 hover:text-primary transition-colors"
        >
          Last Played
          {renderSortIcon('lastPlayedDate')}
        </button>
        <button
          onClick={() => onSort('price')}
          className="w-24 flex items-center gap-2 hover:text-primary transition-colors"
        >
          Price
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex flex-wrap gap-4 mt-2 text-xs text-base-content/60 md:hidden">
              ...
              {item.lastPlayedDate && (
                <span>Last played: {new Date(item.lastPlayedDate).toLocaleDateString()}</span>
              )}
