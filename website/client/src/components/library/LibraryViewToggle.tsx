...
/**
 * LibraryViewToggle - View mode toggle component for the library page.
 * Allows switching between Grid, List, and Compact List views.
 * Implements SPEC.md Section 4.2 View Options.
 */
export default function LibraryViewToggle({ viewMode, onViewModeChange }: LibraryViewToggleProps) {
  return (
    <div className="flex gap-1 bg-base-300 rounded-lg p-1" role="group" aria-label="View mode options">
      {/* Grid View - Thumbnail-based grid layout (SPEC 4.2) */}
      <button
      ...
      {/* List View - Standard list with more details (SPEC 4.2) */}
      <button
      ...
      {/* Compact List View - Dense list for power users (SPEC 4.2) */}
      <button
