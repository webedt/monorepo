...
describe('runHealthChecks', () => {
  ...
  describe('retry behavior', () => {
    ...
    it('should fail after all retries exhausted', async () => {
      ...
      assert.strictEqual((globalThis.fetch as any).mock.callCount(), 3);
    });
  });
...
describe('generatePreviewUrl', () => {
  it('should replace {owner} placeholder', () => {
    const result = generatePreviewUrl(
      'https://preview.example.com/{owner}/',
  ...
  it('should replace {repo} placeholder', () => {
    const result = generatePreviewUrl(
      'https://preview.example.com/{repo}/',
      { owner: 'myorg', repo: 'myrepo', branch: 'main' }
    );
  ...
  it('should replace all placeholders', () => {
    const result = generatePreviewUrl(
      'https://{branch}.{owner}.example.com/{repo}/',
      { owner: 'myorg', repo: 'myrepo', branch: 'main' }
    );
  ...
  it('should replace slashes in branch names with dashes', () => {
    const result = generatePreviewUrl(
      'https://preview.example.com/{branch}/',
      { owner: 'myorg', repo: 'myrepo', branch: 'feature/my-feature' }
    );
  ...
  it('should handle multiple slashes in branch names', () => {
    const result = generatePreviewUrl(
      'https://preview.example.com/{branch}/',
      { owner: 'myorg', repo: 'myrepo', branch: 'feat/scope/ticket-123' }
    );
  ...
  it('should preserve URL without placeholders', () => {
    const result = generatePreviewUrl(
      'https://preview.example.com/static/',
      { owner: 'myorg', repo: 'myrepo', branch: 'main' }
    );
