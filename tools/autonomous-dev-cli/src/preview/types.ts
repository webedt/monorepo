...
export type TaskAction =
  ...
  | 'edit'         // Edit task title/description
  | 'notes'        // Add notes to the task
  | 'details'      // Show full task details
  | 'skip'         // Skip to next task
  | 'back'         // Go back to previous task
  | 'filter'       // Apply filters
  | 'sort'         // Change sort order
  | 'approveAll'   // Approve all remaining tasks
  | 'rejectAll'    // Reject all remaining tasks
